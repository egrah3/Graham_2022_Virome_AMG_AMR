...
---
```{r}
#You may not need all of these, these are just my defalt libraries I always use
library(readr)
library(phyloseq)
library(dplyr)
library(tidyr)
...
#The name of your phyloseq object you want to find the core taxa used in this example is JVIRAL_FINAL
#Make sure to change JVIRAL_FINAL to the name of your phyloseq object of interest
#Also make sure to remove all control samples (index 23 and 25), repeated samples (index 27), and dnase test samples (P33 & P45) from your phyloseq object


#Overall core
```{r}
#Core taxa across 80% of all samples
CORE<- filter_taxa(JVIRAL_FINAL, function(x) sum(x > 0) >= (0.8*length(x)), TRUE)
#barplot of top 10 taxa in core taxa 
CORE.sum<- tapply(taxa_sums(CORE), tax_table(CORE)[, "Bin"], sum, na.rm=TRUE)
COREtop10phyla <-names(sort(CORE.sum, TRUE))[1:10]
CORE_top10 <- prune_taxa((tax_table(CORE)[, "Bin"] %in% COREtop10phyla), CORE)
plot_bar(CORE_top10, x="Subject", fill = "Bin")
```
...
```{r}
#Subset by person 01
P_01 <- subset_samples(JVIRAL_FINAL, Subject=="P01")
...
#P02
```{r}
P_02 <- subset_samples(JVIRAL_FINAL, Subject=="P02")
...
#P03
```{r}
P_03 <- subset_samples(JVIRAL_FINAL, Subject=="P03")
...
#P04
```{r}
P_04 <- subset_samples(JVIRAL_FINAL, Subject=="P04")
...
#P05
```{r}
P_05 <- subset_samples(JVIRAL_FINAL, Subject=="P05")
...
#P06
```{r}
P_06 <- subset_samples(JVIRAL_FINAL, Subject=="P06")
...
#P07
```{r}
P_07 <- subset_samples(JVIRAL_FINAL, Subject=="P07")
...
#P08
```{r}
P_08 <- subset_samples(JVIRAL_FINAL, Subject=="P08")
...
#P09
```{r}
P_09 <- subset_samples(JVIRAL_FINAL, Subject=="P09")
...
#P10
```{r}
P_10 <- subset_samples(JVIRAL_FINAL, Subject=="P10")
...
#P11
```{r}
P_11 <- subset_samples(JVIRAL_FINAL, Subject=="P11")
...
#P12
```{r}
P_12 <- subset_samples(JVIRAL_FINAL, Subject=="P12")
...
#P13
```{r}
P_13 <- subset_samples(JVIRAL_FINAL, Subject=="P13")
...
#P14
```{r}
P_14 <- subset_samples(JVIRAL_FINAL, Subject=="P14")
...
#P15
```{r}
P_15 <- subset_samples(JVIRAL_FINAL, Subject=="P15")
...
#P16
```{r}
P_16 <- subset_samples(JVIRAL_FINAL, Subject=="P16")
...
#P17
```{r}
P_17 <- subset_samples(JVIRAL_FINAL, Subject=="P17")
...
#P18
```{r}
P_18 <- subset_samples(JVIRAL_FINAL, Subject=="P18")
...
#P19
```{r}
P_19 <- subset_samples(JVIRAL_FINAL, Subject=="P19")
...
#P20
```{r}
P_20 <- subset_samples(JVIRAL_FINAL, Subject=="P20")
...
#P21
```{r}
P_21 <- subset_samples(JVIRAL_FINAL, Subject=="P21")
...
#P22
```{r}
P_22 <- subset_samples(JVIRAL_FINAL, Subject=="P22")
...
#P23
```{r}
P_23 <- subset_samples(JVIRAL_FINAL, Subject=="P23")
...
#P24
```{r}
P_24 <- subset_samples(JVIRAL_FINAL, Subject=="P24")
...
#P25
```{r}
P_25 <- subset_samples(JVIRAL_FINAL, Subject=="P25")
...
#P26
```{r}
P_26 <- subset_samples(JVIRAL_FINAL, Subject=="P26")
...
#P27
```{r}
P_27 <- subset_samples(JVIRAL_FINAL, Subject=="P27")
...
#P28
```{r}
P_28 <- subset_samples(JVIRAL_FINAL, Subject=="P28")
...
#P29
```{r}
P_29 <- subset_samples(JVIRAL_FINAL, Subject=="P29")
...
#P30
```{r}
P_30 <- subset_samples(JVIRAL_FINAL, Subject=="P30")
...
#P31
```{r}
P_31 <- subset_samples(JVIRAL_FINAL, Subject=="P31")
...
#P32
```{r}
P_32 <- subset_samples(JVIRAL_FINAL, Subject=="P32")
...
#P34
```{r}
P_34 <- subset_samples(JVIRAL_FINAL, Subject=="P34")
...
#P35
```{r}
P_35 <- subset_samples(JVIRAL_FINAL, Subject=="P35")
...
#P36
```{r}
P_36 <- subset_samples(JVIRAL_FINAL, Subject=="P36")
...
#P37
```{r}
P_37 <- subset_samples(JVIRAL_FINAL, Subject=="P37")
...
#P38
```{r}
P_38 <- subset_samples(JVIRAL_FINAL, Subject=="P38")
...
#P39
```{r}
P_39 <- subset_samples(JVIRAL_FINAL, Subject=="P39")
...
#P40
```{r}
P_40 <- subset_samples(JVIRAL_FINAL, Subject=="P40")
...
#P41
```{r}
P_41 <- subset_samples(JVIRAL_FINAL, Subject=="P41")
...
#P42
```{r}
P_42 <- subset_samples(JVIRAL_FINAL, Subject=="P42")
...
#P43
```{r}
P_43 <- subset_samples(JVIRAL_FINAL, Subject=="P43")
...
#Alpha Diversity of core samples
...
```{r}
shapiro.test(Metadata_core_stat$shannon.vegan)
```


#Beta Diversity of merged core phyloseq objects
...
plot_ordination(norm_merged_groups, ord.merged_groups.pcoa, color = "Subject", shape = "Time_Collected") +
  geom_point(size=1)
```
```{r}
metadata_core <- as(sample_data(norm_merged_groups ), "data.frame")
adonis(phyloseq::distance(norm_merged_groups, method="bray") ~  Location+Gender+Time_Week+Subject/Location+ Subject/Time_Week+Subject,
       data = metadata_core)
```
...
adonis(phyloseq::distance(norm_LH_groups, method="bray") ~  Gender+Time_Week+Subject+Subject/Time_Week,
...
plot_ordination(norm_LH_groups, ord.RH_groups.pcoa, color = "Subject", shape = "Time_Collected") +
  geom_point(size=1)
```
```{r}
metadata_RH_core <- as(sample_data(norm_RH_groups ), "data.frame")
adonis(phyloseq::distance(norm_RH_groups, method="bray") ~  Gender+Time_Week+Subject+Subject/Time_Week,
...
adonis(phyloseq::distance(norm_SC_groups, method="bray") ~  Gender+Time_Week+Subject+Subject/Time_Week,
...
adonis(phyloseq::distance(norm_hands_groups, method="bray") ~  Location+Gender+Time_Week+Subject/Location+ Subject/Time_Week+Subject,
       data = metadata_hands_core)
```

```{r}
core_hands_merge_test <- merge_phyloseq(core_P01LH, core_P02LH, core_P03LH, core_P04LH, core_P05LH, core_P06LH, core_P07LH, 
                            core_P08LH, core_P09LH, core_P10LH, core_P11LH, core_P12LH, core_P13LH, core_P14LH,
                            core_P15LH, core_P16LH, core_P17LH, core_P18LH, core_P19LH, core_P20LH, core_P21LH,
                            core_P22LH, core_P23LH, core_P24LH, core_P25LH,core_P01RH, core_P02RH, core_P03RH, core_P04RH, core_P05RH, core_P06RH, core_P07RH, 
                            core_P08RH, core_P09RH, core_P10RH, core_P11RH, core_P12RH, core_P13RH, core_P14RH,
                            core_P15RH, core_P16RH, core_P17RH, core_P18RH, core_P19RH, core_P20RH, core_P21RH,
                            core_P22RH, core_P23RH, core_P24RH, core_P25RH)
```
```{r}
...
metadata_hands_core_test <- as(sample_data(norm_hands_groups_test ), "data.frame")
adonis(phyloseq::distance(norm_hands_groups_test, method="bray") ~  Location+Gender+Time_Week+Subject/Location+ Subject/Time_Week+Subject,
       data = metadata_hands_core_test)
```
